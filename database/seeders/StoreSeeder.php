...
class StoreSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        settings()->set('email', 'contacts@talabateonline.mr');
        settings()->set('phone', '+222 33 76 76 96');
        ...
        settings()->set('copyrights', 'Copyright © '.date("Y").' <a href="https://iprod.mr" target="_blank">iProd Technologies</a>  -  All Rights Reserved.');
