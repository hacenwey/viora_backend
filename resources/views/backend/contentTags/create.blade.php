...
@section('title',settings()->get('app_name').' | '. trans('global.new').' '. trans('cruds.contentTag.title_singular'))
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backend.content-tags.store") }}" enctype="multipart/form-data">
            {{csrf_field()}}
            @csrf
