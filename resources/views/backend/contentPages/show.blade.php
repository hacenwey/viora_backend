...
@section('title',settings()->get('app_name').' | '. trans('global.show').' '. trans('cruds.contentPage.title_singular'))
...
<div class="card">
    ...
    <div class="card-body">
        <div class="form-group">
            <div class="form-group">
                <a class="btn btn-default" href="{{ route('backend.content-pages.index') }}">
                        ...
                        <td>
                            @if($contentPage->featured_image)
                                <a href="{{ $contentPage->featured_image }}" target="_blank" style="display: inline-block">
                                    <img src="{{ $contentPage->featured_image }}">
                                </a>
                            @endif
                        </td>
                    </tr>
