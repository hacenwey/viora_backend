...
@section('title',settings()->get('app_name').' | '. trans('global.edit').' '. trans('cruds.contentPage.title_singular'))
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backend.content-pages.update", [$contentPage->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                  ...
                  <input id="thumbnail" class="form-control" type="text" name="featured_image" value="{{ $contentPage->featured_image }}">
                </div>
