...
@section('title',settings()->get('app_name').' | '. trans('global.new') . trans('cruds.post.title_singular'))

@section('main-content')

<div class="card">
    <h5 class="card-header">@lang('global.new') @lang('cruds.post.title_singular')</h5>
    <div class="card-body">
      <form method="post" action="{{route('backend.post.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="@lang('global.enter') @lang('cruds.post.fields.title')"  value="{{old('title')}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <select name="tags[]" multiple  data-live-search="true" class="form-control selectpicker">
              <option value="">--@lang('global.select') @lang('cruds.post.fields.tag')--</option>
...
<script>
    ...
    $(document).ready(function() {
      $('#quote').summernote({
        placeholder: "{!! trans('global.write_detailed_quote') !!}",
          tabsize: 2,
          height: 100
      });
    });
