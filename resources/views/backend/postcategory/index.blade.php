...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">@lang('cruds.category.title') @lang('global.list')</h6>
      <a href="{{route('backend.post-category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="@lang('global.add') @lang('cruds.category.title_singular')"><i class="fas fa-plus"></i> @lang('global.add') @lang('cruds.category.title_singular')</a>
    </div>
    <div class="card-body">
          ...
          <tbody>
            @foreach($postCategories as $data)
                <tr>
                    ...
                    <td>
                        <a href="{{route('backend.post-category.edit',$data->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="@lang('global.edit')" data-placement="bottom"><i class="fas fa-edit"></i></a>
                    <form method="POST" action="{{route('backend.post-category.destroy',[$data->id])}}">
                      @csrf
                      @method('delete')
