...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">linges des Commandes @lang('global.list')</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <span style="float:right">{{$commandes->links()}}</span>        
      </div>
    </div>
</div>
