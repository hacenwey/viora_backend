  ...
  <hr class="sidebar-divider">
    ...
    @can('access_store')
            ...
            <li class="nav-item {{ request()->is('admin/category') || request()->is('admin/category/*') ? 'active' : '' }}">
                ...
                <div id="categoryCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @can('add_categories')
                            <a class="collapse-item" href="{{route('backend.category.create')}}">@lang('global.new') @lang('cruds.category.title_singular')</a>
                        @endcan
                    </div>
                </div>
            </li>
        ...
        @can('access_products')
            ...
            <div id="productCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_products')
                        <a class="collapse-item" href="{{route('backend.product.create')}}">@lang('global.new') @lang('cruds.product.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_collections')
            <li class="nav-item {{ request()->is('admin/collections') || request()->is('admin/collection/*') ? 'active' : '' }}">
            ...
            <div id="collectionCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_collections')
                        <a class="collapse-item" href="{{route('backend.collections.create')}}">@lang('global.new') @lang('cruds.collection.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_brands')
            ...
            <div id="brandCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_brands')
                        <a class="collapse-item" href="{{route('backend.brand.create')}}">@lang('global.new') @lang('cruds.brand.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_shippings')
            ...
            <div id="shippingCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_shippings')
                        <a class="collapse-item" href="{{route('backend.shipping.create')}}">@lang('global.new') @lang('cruds.shipping.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_clients')
            ...
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#clientsCollapse" aria-expanded="true" aria-controls="clientsCollapse">
                <i class="fas fa-truck"></i>
            ...
            <div id="clientsCollapse" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_clients')
                        <a class="collapse-item" href="{{route('backend.clients.create')}}">@lang('global.new') @lang('cruds.client.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
    ...
    @can('access_blog')
        ...
        @can('access_posts')
            ...
            <div id="postCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_posts')
                        <a class="collapse-item" href="{{route('backend.post.create')}}">@lang('global.new') @lang('cruds.post.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_post_categories')
            <li class="nav-item {{ request()->is('admin/post-category') || request()->is('admin/post-category/*') ? 'active' : '' }}">
            ...
            <div id="postCategoryCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_post_categories')
                        <a class="collapse-item" href="{{route('backend.post-category.create')}}">@lang('global.new') @lang('cruds.category.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
        ...
        @can('access_post_tags')
            ...
            <div id="tagCollapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    @can('add_post_tags')
                        <a class="collapse-item" href="{{route('backend.post-tag.create')}}">@lang('global.new') @lang('cruds.tag.title_singular')</a>
                    @endcan
                </div>
            </div>
        </li>
    ...
    @can('content_page_access')
        ...
        @can('access_content_category')
            <li class="nav-item {{ request()->is('admin/content-categories') || request()->is('admin/content-categories/*') ? 'active' : '' }}">
        ...
        @can('access_content_tag')
            <li class="nav-item {{ request()->is('admin/content-tags') || request()->is('admin/content-tags/*') ? 'active' : '' }}">
