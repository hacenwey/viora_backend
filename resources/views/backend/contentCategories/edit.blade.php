...
@section('title',settings()->get('app_name').' | '. trans('global.edit').' '. trans('cruds.contentCategory.title_singular'))
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("backend.content-categories.update", [$contentCategory->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
