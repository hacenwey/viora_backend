...
@section('main-content')
    ...
    <form action="{{ route('backend.new_supply') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card mb-5 import-part">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card-body row">
                        ...
                        <div class="form-group col-sm">
                            ...
                            <input type="number" name="journal_duration" max="12" value="3"
                                class="form-control" />
                        </div>
                        <div class="form-group col-sm">
                        ...
                        <div class="form-group text-right col-sm">
                            ...
                            <input type="submit" class="btn btn-primary submit-button"
                                @if ($status === 'IN_PROGRESS') disabled @endif value="Go!" class="form-control" />
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="number" name="qte" class="form-control" id="qte_appro" aria-describedby="emailHelp">
                </div>
        ...
        $(document).ready(function() {
            ...
            $('.check_order_item').click(function(e) {
                ...
                $('#save_data').click(function(e) {
                    ...
                    if(provider === 0) {
                        alert('Merci de selectionner un fournisseur !');
                    } else {
                        // call save function
                        const data = {
                            qte: updated_qte,
