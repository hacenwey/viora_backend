<div id="messages">
    ...
    <span data-count="{{count(messageList())}}" class="badge badge-danger badge-counter">{{count(messageList())}}</span>
    ...
    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
        ...
        <div id="message-items">
            @foreach(messageList() as $message)
                <a class="dropdown-item d-flex align-items-center" href="{{ route('backend.message.show', $message->id) }}">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="{{route('backend.message.index')}}">@lang('global.read_more') @lang('global.messages')</a>
    </div>
</div>
