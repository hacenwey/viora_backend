    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row mb-4">
                ...
                <form class="input-group col-md-3" id="filters" action="{{ route('backend.order.status-filter') }}"
                    method="GET">
                    @csrf
                    ...
                    <select name="status" id="statusFiletred" class="form-control status-filter"
                        ...
                        <option value="new" {{ Request()->get('status') == 'new' ? 'selected' : '' }}>
                            @lang('global.new')</option>
                        ...
                        <option value="cancel" {{ Request()->get('status') == 'cancel' ? 'selected' : '' }}>
                            @lang('global.canceled')</option>
                        <option value="delete" {{ Request()->get('status') == 'delete' ? 'selected' : '' }}>
            ...
            <div class="table-responsive">
                @if (count($orders) > 0)
                        ...
                        <tbody>
                            @foreach ($orders as $order)
                                <tr id="{{ $order->id }}">
                                    ...
                                    <td>
                                        <a href="{{ route('backend.order.show', ['order' => $order->id]) }}"
                    ...
                    @include('backend.layouts.pagination', [
                        'paginator' => $orders->appends(request()->query()),
                        'name' => 'order',
                    ])
                @else
