...
@section('title',settings()->get('app_name').' | DASHBOARD')
...
@endsection
  ...
  function drawChart()
  {
      ...
      var options = {
          title : "{!! trans('global.last_seven_days_users') !!}"
      };
                      ...
                      yAxes: [{
                        ticks: {
                          ...
                          callback: function(value, index, values) {
                            return number_format(value) +' '+App.settings.currency_code;
                          }
                        },
                        gridLines: {
                    ...
                    tooltips: {
                      ...
                      callbacks: {
                        label: function(tooltipItem, chart) {
                          ...
                          return datasetLabel + ': ' + number_format(tooltipItem.yLabel) +' '+App.settings.currency_code;
                        }
                      }
                    }
                  }
