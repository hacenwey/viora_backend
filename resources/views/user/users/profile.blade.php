...
<div class="card shadow mb-4">
   ...
   <div class="card-header py-3">
     ...
     <ul class="breadcrumbs">
         <li><a href="{{route('users.user')}}" style="color:#999">Dashboard</a></li>
   ...
   <div class="card-body">
        <div class="row">
                    ...
                    <div class="card-body mt-4 ml-2">
                      ...
                      <p class="card-text text-left">
                          <small class="text-muted">
                              ...
                              @foreach($profile->roles as $key => $item)
            ...
            <div class="col-md-8">
                <form class="border px-4 pt-2 pb-3" method="POST" action="{{route('users.user-profile-update',$profile->id)}}">
                    @csrf
                    <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input id="phone" type="text" name="phone_number" placeholder="Enter phone number"  value="{{$profile->phone_number}}" class="form-control">
                        @error('phone_number')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                      </div>
                      ...
                      <div class="form-group">
                          ...
                          <select class="form-control" disabled>
                                  <option value="">{{ count($profile->roles) > 0 ? $profile->roles[0]->title : '' }}</option>
                          </select>
                        @error('role')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
