...
<body class="c-app">
    @include('central._partials.menu')
    <div class="c-wrapper">
                    ...
                    <li class="c-header-nav-item dropdown d-md-down-none">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            @foreach(config('panel.available_languages') as $code => $lang)
                                <a class="dropdown-item" href="{{ url()->current() }}?change_language={{ $lang['short_code'] }}">{{ strtoupper($lang['short_code']) }} ({{ $lang['short_code'] }})</a>
                            @endforeach
                        </div>
                    </li>
                @endif
  ...
  $.fn.dataTable.ext.classes.sPageButton = '';
    ...
    $('.searchable-field').select2({
        ...
        ajax: {
            url: '{{ route("central.globalSearch") }}',
            dataType: 'json',
            type: 'GET',
            delay: 200,
            data: function (term) {
