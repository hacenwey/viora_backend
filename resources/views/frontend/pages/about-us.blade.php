...
@section('title',settings()->get('app_name').' | '.trans('global.about_us'))
...
@section('main-content')
                ...
                <div class="col-sm-6">
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">{{ trans('global.about_us') }}</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <section class="about-page section-b-space">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner-section"><img src="../assets/images/about/about%20us.jpg"
