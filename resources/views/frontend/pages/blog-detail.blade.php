                    ...
                    <div class="blog-single-main">
                        <div class="row">
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        ...
                                        <!-- Comment Form -->
                                        <form class="form comment_form" id="commentForm" action="{{route('backend.post-comment.store',$post->slug)}}" method="POST">
                                            @csrf
                                            <div class="row">
                            ...
                            <p class="text-center p-5">
                                You need to <a href="{{route('backend.login.form')}}" style="color:rgb(54, 54, 204)">Login</a> OR <a style="color:blue" href="{{route('backend.register.form')}}">Register</a> for comment.
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                ...
                                <form action="{{route('backend.subscribe')}}" method="POST">
                                    @csrf
