...
trait CsvImportTrait
{
    public function processCsvImport(Request $request)
    {
        try {
            ...
            $model     = "App\Models\Tenant\\" . $modelName;
    ...
    public function parseCsvImport(Request $request)
    {
        ...
        $fullModelName = "App\Models\Tenant\\" . $modelName;
        ...
        $routeName = 'backend.' . strtolower(Str::plural(Str::kebab($modelName))) . '.processCsvImport';
